...
export default function Project({ imageSrc, title, content, logo }: ProjectProps) {
  ...
  return (
    <>
      <motion.div className="relative w-[80vw] h-[80vw] md:w-[40vw] md:h-[40vw] overflow-hidden bg-primary rounded-[5vw] md:rounded-[2vw] flex flex-col justify-end cursor-pointer">
