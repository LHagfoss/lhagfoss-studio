...
export default function About() {
    ...
    const text2 = "I specializing in React, Next.js, TypeScript, and other JavaScript frameworks. I have a strong understanding of various software and programs to develop a good website for UI and UX.";
