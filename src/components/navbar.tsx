...
export default function Navbar() {
    ...
    return (
        <div className="navbar fixed w-[100vw] flex justify-center items-center p-10">
            <div className="w-full font-bestFont text-[#1a1a1a] justify-between items-start leading-10 tracking-wide sm:text-[2.5vw] sm:hidden md:text-[2vw] md:flex lg:text-[1.5vw] lg:flex hidden">
                ...
                <div className="flex flex-col gap-2">
                    <div className="flex gap-5">
                        <motion.div initial={{ y: -200 }} animate={{ y: 0, opacity: 1 }} transition={{ duration: 1, delay: 3.4, ease: easeInOut }} className=""><Link href="/signup" className="bg-[#1a1a1a] text-[#ebebeb] p-1 px-3 rounded-[5px]">Sign Up</Link></motion.div>
                        <motion.div initial={{ y: -200 }} animate={{ y: 0, opacity: 1 }} transition={{ duration: 1, delay: 3.6, ease: easeInOut }} className=""><Link href="/signin" className="border border-[#1a1a1a] p-1 px-3 rounded-[5px]">Sign In</Link></motion.div>
                    </div>
                    <motion.div initial={{ y: -200 }} animate={{ y: 0, opacity: 1 }} transition={{ duration: 1, delay: 3.8, ease: easeInOut }} className=""><Link href="/">norway, krs</Link></motion.div>
                </div>
            </div>
