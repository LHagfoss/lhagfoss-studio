    ...
    return (
        <div className="navbar top-0 absolute w-[100vw] flex justify-center items-center p-7">
            <div className="w-full font-bestFont text-[#1a1a1a] justify-between items-start tracking-wide sm:text-[2.5vw] sm:hidden md:text-[2vw] md:flex lg:text-[1.5vw] lg:flex hidden">
                ...
                <div className="flex flex-col">
                    <motion.div initial={{ y: -250 }} animate={{ y: 0, opacity: 1 }} transition={{ duration: 1, delay: 2.2, ease: easeInOut }}><Link href="/" className="p-2 px-4 hover:bg-[#1a1a1a] hover:text-[#ebebeb] transition-all duration-300 rounded-full">digital studio</Link></motion.div>
                </div>
                <div className="flex flex-col gap-3">
                    <motion.div initial={{ y: -250 }} animate={{ y: 0, opacity: 1 }} transition={{ duration: 1, delay: 2.4, ease: easeInOut }}><Link href="/" className="p-2 px-4 hover:bg-[#1a1a1a] hover:text-[#ebebeb] transition-all duration-300 rounded-full">project / work</Link></motion.div>
                    <motion.div initial={{ y: -250 }} animate={{ y: 0, opacity: 1 }} transition={{ duration: 1, delay: 2.6, ease: easeInOut }}><Link href="/" className="p-2 px-4 hover:bg-[#1a1a1a] hover:text-[#ebebeb] transition-all duration-300 rounded-full">about / info</Link></motion.div>
                    <motion.div initial={{ y: -250 }} animate={{ y: 0, opacity: 1 }} transition={{ duration: 1, delay: 2.8, ease: easeInOut }}><Link href="/" className="p-2 px-4 hover:bg-[#1a1a1a] hover:text-[#ebebeb] transition-all duration-300 rounded-full">other</Link></motion.div>
                </div>
                <div className="flex flex-col gap-3">
                    <motion.div initial={{ y: -250 }} animate={{ y: 0, opacity: 1 }} transition={{ duration: 1, delay: 3, ease: easeInOut }}><Link href="/" className="p-2 px-4 hover:bg-[#1a1a1a] hover:text-[#ebebeb] transition-all duration-300 rounded-full">github</Link></motion.div>
                    <motion.div initial={{ y: -250 }} animate={{ y: 0, opacity: 1 }} transition={{ duration: 1, delay: 3.2, ease: easeInOut }}><Link href="/contact" className="p-2 px-4 hover:bg-[#1a1a1a] hover:text-[#ebebeb] transition-all duration-300 rounded-full">contact</Link></motion.div>
                </div>
                <div className="flex gap-3">
                    <motion.div initial={{ y: -250 }} animate={{ y: 0, opacity: 1 }} transition={{ duration: 1, delay: 3.6, ease: easeInOut }}><Link href="/contact" className="bg-primary text-secondary p-2 px-4 rounded-full flex gap-2 border"><Image src={send} alt=""></Image><div className="">message</div></Link></motion.div>
                </div>
            </div>
            <div className="navbar w-full font-bestFont text-[#1a1a1a] sm:text-[2.5vw] sm:flex md:text-[2vw] md:hidden lg:text-[1.5vw] lg:hidden flex">
                ...
                >
                    ...
                    <motion.div initial={{ x: -400 }} animate={{ x: 0, opacity: 1 }} transition={{ duration: 1, delay: 2, ease: easeInOut }}><Link href="/">lucas</Link></motion.div>
                        ...
                        <motion.div initial={{ x: -400 }} animate={{ x: 0, opacity: 1 }} transition={{ duration: 1, delay: 3.4, ease: easeInOut }}><Link href="/">norway, krs</Link></motion.div>
                    </div>
            </motion.div>
            </div>
        </div>
