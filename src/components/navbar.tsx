...
export default function Navbar() {
    ...
    return (
        <div className="navcbar fixed w-[100vw] flex justify-center items-center p-10">
            <div className="w-full font-bestFont text-[#1a1a1a] flex justify-between items-start overflow-hidden tracking-wide leading-10 sm:text-[2.5vw] md:text-[2vw] lg:text-[1.5vw]">
