        ...
        <div className="navbar fixed w-[100vw] flex justify-center items-center p-10">
            <div className="w-full font-bestFont text-[#1a1a1a] justify-between items-start overflow-hidden tracking-wide leading-10 sm:text-[2.5vw] sm:hidden md:text-[2vw] md:flex lg:text-[1.5vw] lg:flex hidden">
                ...
                <div className="flex flex-col">
                    ...
                    <motion.div initial={{ y: -120 }} animate={{ y: 0, opacity: 1 }} transition={{ duration: 1, delay: 2.8, ease: easeInOut }} className=""><Link href="/">other</Link></motion.div>
                </div>
                <div className="flex flex-col">
                    <motion.div initial={{ y: -120 }} animate={{ y: 0, opacity: 1 }} transition={{ duration: 1, delay: 3, ease: easeInOut }} className=""><Link href="/">github</Link></motion.div>
                    <motion.div initial={{ y: -120 }} animate={{ y: 0, opacity: 1 }} transition={{ duration: 1, delay: 3.2, ease: easeInOut }} className=""><Link href="/">contact</Link></motion.div>
                </div>
                <div className="flex flex-col">
