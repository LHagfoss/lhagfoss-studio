...
export default function NavnAnimation() {
    ...
    return (
        <div className="absolute w-[100vw] h-[100vh] md:h-[80vh] flex justify-center items-center">
            <div className="font-bestFont text-[#1a1a1a] flex justify-center items-center text-[40vw] h-[30vw] overflow-hidden">
