...
export default function NavnAnimation() {
    ...
    return (
        <>
            <div className={`navbar fixed justify-center items-center duration-1000 select-none ${isScrolled ? 'z-20 onTop top-[0] translate-y-[0] w-[40vw] md:w-[11vw] h-[5vh] mx-3 my-7 md:m-10 md:mx-44 p-0' : ' z-0 w-[100vw] top-[50%] translate-y-[-50%] h-[50vh] p-5 md:p-10 m-0'}`}>
