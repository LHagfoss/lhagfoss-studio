...
export default function NavnAnimation() {
    ...
    return (
        <>
            <div className={`absolute justify-center items-center transition-fontSize duration-1000 select-none z-20 w-[100vw] top-[50%] translate-y-[-50%] h-[50vh] p-5 md:px-10 m-0 origin-center`}>
