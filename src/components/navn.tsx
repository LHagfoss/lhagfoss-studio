...
export default function NavnAnimation() {
    ...
    return (
        <>
            <div className={`navbar z-20 onTop fixed justify-center items-center duration-1000 select-none ${isScrolled ? 'w-[40vw] md:w-[11vw] h-[5vh] m-5 md:m-10 p-0' : 'w-[100vw] h-[100vh] p-5 md:p-10 m-0'} `}>
