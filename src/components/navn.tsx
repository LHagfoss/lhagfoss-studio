        ...
        <>
            <div className={`navbar fixed justify-center items-center duration-1000 ${isScrolled ? 'w-[40vw] md:w-[11vw] h-[5vh] m-5 md:m-10 p-0' : 'w-[100vw] h-[100vh] p-5 md:p-10 m-0'} `}>
                <div className="flex w-full h-full justify-center items-center">
                    <div className={`font-bestFont text-secondary flex justify-center items-center ${isScrolled ? 'text-[10vw] md:text-[3vw] h-[10vw] md:h-[3vw]' : 'text-[20vw] h-[30vw]'} overflow-hidden duration-1000 cursor-pointer`}>
                    ...
                    <div className={`absolute font-bestFont text-secondary cursor-pointer ${isScrolled ? 'text-[2vw] md:text-[1vw] mt-[8vw] ml-[11vw] md:mt-[2.5vw] md:ml-[4.5vw]' : 'text-[5vw] mt-[16vw] ml-[24vw]'} overflow-hidden duration-1000`}>
