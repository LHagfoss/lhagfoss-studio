                    ...
                    <div className="p-5 md:p-44 w-[100vw] h-[100vw]">
                        <div className="w-full h-full grid grid-rows-4 grid-cols-4 gap-1 md:gap-5">
                            <div className="bg-primary row-span-1 col-span-2 rounded-[2vw] overflow-hidden">
                                <motion.div initial={{ y: 550 }} animate={{ y: 0 }} transition={{ delay: 1.1, duration: 1, ease: easeInOut }}  className="text-[#bebebe] bg-[#655bff] text-[1.2vw] flex flex-col justify-between w-full p-5 h-full">
                            ...
                            <div className="bg-primary row-span-2 col-span-1 rounded-[2vw] overflow-hidden">
                                <div className="w-full h-full rounded-[2vw] p-5 flex flex-col justify-between">
                                    <motion.div initial={{ y: -550 }} animate={{ y: 0 }} transition={{ delay: 1.2, duration: 1, ease: easeInOut }} className="flex flex-col mb-5">
                                    ...
                                    <div className="w-full flex flex-col gap-3">
                                        <motion.div initial={{ x: -550 }} animate={{ x: 0 }} transition={{ delay: 1.3, duration: 1, ease: easeInOut }} className="w-full max-h-[200px] bg-fourth rounded-[1vw] p-3">
                                        ...
                                        <motion.div initial={{ x: 550 }} animate={{ x: 0 }} transition={{ delay: 1.4, duration: 1, ease: easeInOut }} className="w-full max-h-[200px] bg-fourth rounded-[1vw] p-3">
                                            <div className="text-secondary flex items-center justify-between">
                                            <div className="flex gap-1">
                                                <Image src={profileIcon} alt="profile" className=""></Image>
                                        ...
                                        <motion.div initial={{ x: -550 }} animate={{ x: 0 }} transition={{ delay: 1.5, duration: 1, ease: easeInOut }} className="w-full max-h-[200px] bg-fourth rounded-[1vw] p-3">
                                            <div className="text-secondary flex items-center justify-between">
                                            <div className="flex gap-1">
                                                <Image src={profileIcon} alt="profile" className=""></Image>
                                        ...
                                        <motion.div initial={{ x: 550 }} animate={{ x: 0 }} transition={{ delay: 1.6, duration: 1, ease: easeInOut }} className="w-full max-h-[200px] bg-fourth rounded-[1vw] p-3">
                                        ...
                                        <motion.div initial={{ x: -550 }} animate={{ x: 0 }} transition={{ delay: 1.7, duration: 1, ease: easeInOut }} className="w-full max-h-[200px] bg-fourth rounded-[1vw] p-3">
                                            <div className="text-secondary flex justify-between items-center">
                                            <div className="flex gap-1">
                                                <Image src={profileIcon} alt="profile" className=""></Image>
                                                <div className="text-[1vw]">Lucas Hagfoss</div>
                            ...
                            <div className="bg-primary row-span-1 col-span-1 rounded-[2vw] overflow-hidden">
                                <motion.div initial={{ x: 550 }} animate={{ x: 0 }} transition={{ delay: 1.7, duration: 1, ease: easeInOut }} className="w-full h-full bg-[#171515] flex justify-center items-center rounded-[2vw] relative inset-0">
                                    <Image src={ReactJSLogo} alt="reactjs image" className="w-full h-full object-cover"></Image>
                                </motion.div>
                            </div>
                            <div className="bg-primary row-span-2 col-span-1 rounded-[2vw] overflow-hidden">
                                <motion.div initial={{ x: -550 }} animate={{ x: 0 }} transition={{ delay: 1.8, duration: 1, ease: easeInOut }} className="w-full h-full grid grid-rows-6 grid-cols-3 p-5 gap-3">
                            ...
                            <div className="bg-primary row-span-1 col-span-1 rounded-[2vw] overflow-hidden">
                                <motion.div initial={{ y: 550 }} animate={{ y: 0 }} transition={{ delay: 1.9, duration: 1, ease: easeInOut }} className="w-full h-full flex flex-col justify-between rounded-[2vw]">
                                    <Image src={NextJSLogo} alt="nextjs image" className="w-full h-full object-cover"></Image>
                                </motion.div>
                            </div>
                            <div className="bg-primary row-span-1 col-span-1 rounded-[2vw] overflow-hidden">
                                <motion.div initial={{ y: -550 }} animate={{ y: 0 }} transition={{ delay: 2, duration: 1, ease: easeInOut }} className="w-full h-full bg-[#655bff] p-2 md:p-5 flex flex-col justify-between rounded-[2vw] ">
                            ...
                            <div className="bg-primary row-span-1 col-span-3 rounded-[2vw] overflow-hidden">
                                <motion.div initial={{ y: -550 }} animate={{ y: 0 }} transition={{ delay: 2.1, duration: 1, ease: easeInOut }} className="h-full p-5 rounded-[2vw] flex flex-col gap-2 w-2/3">
